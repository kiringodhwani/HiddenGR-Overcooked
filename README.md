# Hidden Goal Recognition (GR) in the Overcooked Environment"
...
[<img width="808" alt="Image" src="https://github.com/user-attachments/assets/bdb0834f-0fd7-4d32-85e6-36d31e560d32" />](https://youtu.be/JN4FOKtD4w0)
...
`python main.py --num-agents 2 --level KirinTest1 --model1 bd --model2 bd --record`

This runs a Hungry-Thirsty experiment with two agents (agent 1 = "fetcher", agent 2 = "human") on the 'KirinTest1' level. It also **records** the experiment, such that you can watch a replay afterwards. Please ignore the model selections ("--model1 bd --model2 bd"). Right now, we hard code agent 1 as the "fetcher" and agent 2 as the "human" in the ***initialize_agents()*** function in ***main.py*** (gym-cooking/gym_cooking/main.py).
